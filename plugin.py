...
class BasePlugin:
    ...
    def onStart(self):
        ...
        if 3 not in Devices:
            Domoticz.Device(Name="TempHumBaro", Unit=3, Type=84, Subtype=16, Used=1).Create()
        ...
        if 5 not in Devices:
            Domoticz.Device(Name="Today THB", Unit=5, Type=84, Subtype=16, Used=1).Create()
    ...
    def onHeartbeat(self):
        ...
        if self.MeteoRequest <= now:
            ...
            if jsonData:
                ...
                if self.THBBarStat == 800 :
                    self.THBBarStat = 6 #Forecast: 0 = Heavy Snow, 1 = Snow, 2 = Heavy Rain, 3 = Rain, 4 = Cloudy, 5 = Some Clouds, 6 = Sunny, 7 = Unknown, 8 = Unstable, 9 = Stable
                elif self.THBBarStat > 800 :
                        if self.THBBarStat == 801 :
                            self.THBBarStat = 5
                        elif  self.THBBarStat == 802 :
                            self.THBBarStat = 5
                        elif  self.THBBarStat >= 803 :
                            self.THBBarStat = 4
                else :
                    if self.THBBarStat < 500 :
                        self.THBBarStat = 2
                    elif self.THBBarStat < 600 :
                        self.THBBarStat = 3
                    elif self.THBBarStat < 700 :
                        self.THBBarStat = 1
                    else :
                        self.THBBarStat = 7
