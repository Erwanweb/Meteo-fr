...
class BasePlugin:
    ...
    def onHeartbeat(self):
        ...
        if self.MeteoRequest <= now:
            WeatherMapAPI("&exclude=minutely,hourly")
...
def WeatherMapAPI(APICall):
    ...
    jsonData = None
    url = "https://api.openweathermap.org/data/3.0/onecall?appid={}&lat={}&lon={}&units=metric&lang=fr{}".format(Parameters["Password"], Parameters["Mode1"], Parameters["Mode2"], parse.quote(APICall, safe="&="))
