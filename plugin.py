...
class BasePlugin:
    ...
    def onStart(self):
        ...
        if 4 not in Devices:
            ...
            devicecreated.append(deviceparam(4, 0, "90;N;16;25;20.1;21.5"))  # default is 90,N,16,25,20º,21º
        if 5 not in Devices:
        ...
        if 8 not in Devices:
            Domoticz.Device(Name="DJU-Prev", Unit=8, TypeName="Temperature", Used=1).Create()
            devicecreated.append(deviceparam(8, 0, "0"))  # default is 20 degrees
